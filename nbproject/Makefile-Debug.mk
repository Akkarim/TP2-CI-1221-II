...
${OBJECTDIR}/Diccionario/Diccionario.o: Diccionario/Diccionario.cpp
	...
	${RM} "$@.d"
	$(COMPILE.cc) -g -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Diccionario/Diccionario.o Diccionario/Diccionario.cpp

${OBJECTDIR}/Grafo/ListaAdyacencia.o: Grafo/ListaAdyacencia.cpp
	${MKDIR} -p ${OBJECTDIR}/Grafo
	${RM} "$@.d"
	$(COMPILE.cc) -g -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Grafo/ListaAdyacencia.o Grafo/ListaAdyacencia.cpp

${OBJECTDIR}/Grafo/MatrizAdyacencia.o: Grafo/MatrizAdyacencia.cpp
	${MKDIR} -p ${OBJECTDIR}/Grafo
	${RM} "$@.d"
	$(COMPILE.cc) -g -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Grafo/MatrizAdyacencia.o Grafo/MatrizAdyacencia.cpp
